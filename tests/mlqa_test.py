...
class TestMLQA(unittest.TestCase):
    ...
    def test_mlqa_prefix_mt0(self):
        template = PromptTemplate("mlqa")
        prompt_template = template.get_template(
            "mT0", "mlqa-prefix-prompt-mt0")
