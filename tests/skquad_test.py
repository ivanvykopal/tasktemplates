...
class Testskquad(unittest.TestCase):
    ...
    def test_skquad_prefix_mt0(self):
        template = PromptTemplate("skquad")
        prompt_template = template.get_template(
            "mT0", "skquad-prefix-prompt-mt0")
    ...
    def test_skquad_instruct1_mt0(self):
        template = PromptTemplate("skquad")
        prompt_template = template.get_template(
            "mT0", "skquad-instruct1-prompt-mt0")
    ...
    def test_skquad_instruct2_mt0(self):
        template = PromptTemplate("skquad")
        prompt_template = template.get_template(
            "mT0", "skquad-instruct2-prompt-mt0")
    ...
    def test_skquad_instruct3_mt0(self):
        template = PromptTemplate("skquad")
        prompt_template = template.get_template(
            "mT0", "skquad-instruct3-prompt-mt0")
    ...
    def test_skquad_instruct4_mt0(self):
        template = PromptTemplate("skquad")
        prompt_template = template.get_template(
            "mT0", "skquad-instruct4-prompt-mt0")
